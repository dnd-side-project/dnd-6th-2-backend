import { Controller, Get, Res, HttpStatus, Param, NotFoundException, Post, Body, Delete, Patch } from '@nestjs/common';
import { BlogService } from './blog.service';
import { createBlogDto } from './dto/createBlog.dto';
import { updateBlogDto } from './dto/updateBlog.dto';
import { ApiTags, ApiBody, ApiResponse, ApiCreatedResponse } from '@nestjs/swagger';
